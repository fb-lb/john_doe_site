                    ...
                    <div>
                        <section>
                            ...
                            <form action="#" method='post'>
                                ...
                                <textarea className='form-control' name="message" id="message" placeholder='Votre message' rows='4' maxLength={1500} value={message} onChange={e => setMessage(e.target.value)}></textarea>
